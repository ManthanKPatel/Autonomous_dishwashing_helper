...
if __name__ == '__main__':
    ...
    #dataset_path = 'D:/University of Toronto/MIE1076- AI Application in Robotics II/Project/Code/Grasping/Dataset_grasping'
    image_set = 'train'
    ...
    img, gt_rect = train_dataset.__getitem__(6)
