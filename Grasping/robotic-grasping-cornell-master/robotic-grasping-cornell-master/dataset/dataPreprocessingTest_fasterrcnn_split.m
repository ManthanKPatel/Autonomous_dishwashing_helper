...
imgTestOutDir = 'D:/University of Toronto/MIE1076- AI Application in Robotics II/Project/Code/Grasping/robotic-grasping-cornell-master/dataset/grasp/Images_Test/Cropped320_rgd';
imgDataOutDir = 'D:/University of Toronto/MIE1076- AI Application in Robotics II/Project/Code/Grasping/robotic-grasping-cornell-master/dataset/grasp/Images';
annotationDataOutDir = 'D:/University of Toronto/MIE1076- AI Application in Robotics II/Project/Code/Grasping/robotic-grasping-cornell-master/dataset/grasp/Annotations';
imgSetTrain = 'D:/University of Toronto/MIE1076- AI Application in Robotics II/Project/Code/Grasping/robotic-grasping-cornell-master/dataset/grasp/ImageSets/train.txt'; 
imgSetTest = 'D:/University of Toronto/MIE1076- AI Application in Robotics II/Project/Code/Grasping/robotic-grasping-cornell-master/dataset/grasp/ImageSets/test.txt';
%%
for folder = 1:10
    display(['processing folder ' int2str(folder)])
    % sprintf('%02d',folder): int to str, %02d: 01, 02, etc.
    % raw data from Cornell dataset
    imgDataDir = ['D:/University of Toronto/MIE1076- AI Application in Robotics II/Project/Code/Grasping/Dataset_grasping/' sprintf('%02d',folder)];
    txtDataDir = ['D:/University of Toronto/MIE1076- AI Application in Robotics II/Project/Code/Grasping/Dataset_grasping/' sprintf('%02d',folder)];   
